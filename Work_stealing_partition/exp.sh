...
exp_object=("netcard_iccad" "leon2_iccad" "leon3mp_iccad" "des_perf" "vga_lcd")
exp_partition=("_partition_vivekDAG_GDCA_origin()" "_partition_vivekDAG_GDCA_cpu_threadpool()")
