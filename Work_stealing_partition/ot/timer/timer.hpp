...
class Timer {
  ...
  public:
    ...
    ~Timer() {
      ...
      std::cout << "CPU_Taskflow_par_runtime: " << CPU_Taskflow_par_runtime << "\n";
      std::cout << "CPU_Threadpool_par_runtime: " << CPU_Threadpool_par_runtime << "\n";  
  ...
  private:
    ...
    size_t CPU_Async_par_runtime = 0;
    size_t CPU_Taskflow_par_runtime = 0;
    size_t CPU_Threadpool_par_runtime = 0;
    ...
    void _partition_vivekDAG_GDCA_cpu_async();
    void _partition_vivekDAG_GDCA_cpu_taskflow();
    void _partition_vivekDAG_GDCA_cpu_threadpool();
    void _GDCA_dfs();
    ...
    void _GDCA_build_coarsen_graph_cpu_async();
    ...
    /*
     * partition threadpool
     */

    void threadpool_partition(); 
};
