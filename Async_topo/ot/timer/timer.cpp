...
void Timer::_update_timing() {
  ...
  // partition vivekDAG 
  _partition_vivekDAG_GDCA_cpu_parallel();
...
void Timer::_partition_vivekDAG_GDCA_cpu_parallel() {
   ...
   */
  _GDCA_build_coarsen_graph_cpu_parallel();
...
void Timer::_GDCA_build_coarsen_graph_cpu_parallel() {
